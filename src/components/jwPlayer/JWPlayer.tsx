...
const RNJWPlayerManager = NativeModules.JWPlayerModule;

const RCT_RNJWPLAYER_REF = 'jwplayer';

const RNJWPlayer = requireNativeComponent('JWPlayer');
...
export const JWPlayerState = JWPlayerStateAndroid;
...
export default class JWPlayer extends Component {
  ...
  setPlaylistIndex(index) {
    if (RNJWPlayerManager)
      RNJWPlayerManager.setPlaylistIndex(this.getRNJWPlayerBridgeHandle(), index);
  }
  ...
  loadPlaylistItem(playlistItem) {
    if (RNJWPlayerManager)
      RNJWPlayerManager.loadPlaylistItem(this.getRNJWPlayerBridgeHandle(), playlistItem);
  }

  loadPlaylist(playlist) {
    if (RNJWPlayerManager)
      RNJWPlayerManager.loadPlaylist(this.getRNJWPlayerBridgeHandle(), playlist);
  }
  ...
  render() {
    return <RNJWPlayer ref={RCT_RNJWPLAYER_REF} key="RNJWPlayerKey" {...this.props} />;
  }
}
